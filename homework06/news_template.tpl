...
<html>
    ...
    <body>
        <div class="ui container" style="padding-top: 10px;">
          <center>  <a href="/classify?type=0" class="ui right floated small primary button">Sort my news!</a> </center>
          <center>  <a href="/classify?type=1" class="ui right floated small primary button">I need only cool news</a> </center>
